...
const playSongListDetail = async(source: LX.OnlineSource | 'local', link: string, playIndex?: number) => {
...
export const playSonglist = async(source: LX.OnlineSource | 'local', link: string, playIndex?: number) => {
  try {
